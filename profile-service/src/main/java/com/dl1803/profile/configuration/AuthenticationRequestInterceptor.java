...
public class AuthenticationRequestInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate template) {
        ...
        // RequestContextHolder : class hỗ trợ lấy request hiện tại kiểu RequestAttributes(kiểu tổng quát, k có hàm
        // getRequest())
        // ServletRequestAttributes là 1 class imple RequestAttributes dành cho http servlet(nên cần ép kiểu), có thể
        // getRequest() để lấy HttpServletRequest
