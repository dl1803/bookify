...
import com.dl1803.chat.repository.httpClient.IdentityClient;
...
public class IdentityService {
    ...
    public IntrospectResponse introspect(IntrospectRequest request){
        try {
            ...
            if (Objects.isNull(result)) { // tránh case identity service run fail(có thể do lỗi mạng hay chưa start)
